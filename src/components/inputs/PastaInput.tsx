...
interface PastaInputProps {
  /** Autocomplete suggestions for pasta types */
  suggestions: string[];
  /** Previously guessed pasta types */
...
/**
 * Specialized input component for pasta type guessing phase
 *
 * Handles:
 * - Autocomplete suggestions for pasta types
 ...
 */
export const PastaInput: React.FC<PastaInputProps> = ({
  suggestions,
  previousGuesses,
  acceptableGuesses,
  onGuess,
  ...
  const handleSubmit = (guess: string) => {
    ...
    if (previousGuesses.includes(trimmed)) {
      triggerShake();
      toast.error("You already guessed that pasta!");
      return;
    }
